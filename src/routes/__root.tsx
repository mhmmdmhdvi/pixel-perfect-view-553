  ...
  head: () => ({
    meta: [
      ...
      { title: "Sendable — Create something worth sending" },
      {
        name: "description",
        content:
          "Make interactive invitations, surprises and memories in minutes, then share them with one link.",
      },
      { name: "author", content: "Sendable" },
      { property: "og:title", content: "Sendable — Create something worth sending" },
      {
        property: "og:description",
        content: "Interactive invitations and surprises, sent with a single link.",
      },
